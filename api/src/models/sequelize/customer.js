module.exports = function (sequelize, DataTypes) {
  ...
  Customer.associate = function (models) {
    ...
    Customer.hasMany(models.SentEmail, { as: 'sentEmails', foreignKey: 'customerId', scope: { userType: 'customerStaff' } })
    Customer.hasMany(models.EmailError, { as: 'emailErrors', foreignKey: 'customerId', scope: { userType: 'customerStaff' } })
  }
